...
Move_RAGE_POWDER:
	loadspritegfx ANIM_TAG_STUN_SPORE
	createvisualtask AnimTask_BlendParticle, 5, ANIM_TAG_STUN_SPORE, 0, 6, 6, RGB_RED
	loopsewithpan SE_M_POISON_POWDER, SOUND_PAN_TARGET, 10, 6
	createsprite gStunSporeParticleSpriteTemplate, ANIM_TARGET, 2, -30, -22, 117, 80, 5, 1
	createsprite gStunSporeParticleSpriteTemplate, ANIM_TARGET, 2, 10, -22, 117, 80, -5, 1
	createsprite gStunSporeParticleSpriteTemplate, ANIM_TARGET, 2, -25, -22, 117, 112, 5, 3
...
Move_NEUROTOXIN:
	...
	createsprite gNeurotoxinElectricitySpriteTemplate, ANIM_TARGET, 2, 5, 0, 5, 0
	delay 2
	createsprite gNeurotoxinElectricitySpriteTemplate, ANIM_TARGET, 2, -5, 10, 5, 1
	delay 2
	createsprite gNeurotoxinElectricitySpriteTemplate, ANIM_TARGET, 2, 15, 20, 5, 2
	delay 2
	createsprite gNeurotoxinElectricitySpriteTemplate, ANIM_TARGET, 2, -15, -10, 5, 0
	delay 2
	createsprite gNeurotoxinElectricitySpriteTemplate, ANIM_TARGET, 2, 25, 0, 5, 1
	delay 2
	createsprite gNeurotoxinElectricitySpriteTemplate, ANIM_TARGET, 2, -8, 8, 5, 2
	delay 2
	createsprite gNeurotoxinElectricitySpriteTemplate, ANIM_TARGET, 2, 2, -8, 5, 0
	delay 2
	createsprite gNeurotoxinElectricitySpriteTemplate, ANIM_TARGET, 2, -20, 15, 5, 1
	waitforvisualfinish
	clearmonbg ANIM_TARGET
	blendoff
	end
...
Move_DRAIN_PUNCH:
	...
	setalpha 12, 8
	playsewithpan SE_M_COMET_PUNCH, SOUND_PAN_TARGET
	createsprite gFistFootSpriteTemplate, ANIM_TARGET, 3, 0, 0, 30, 1, 0
	createsprite gBasicHitSplatSpriteTemplate, ANIM_TARGET, 2, 0, 0, ANIM_TARGET, 1
	createsprite gSimplePaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG, 1, 0, 12, RGB(31, 22, 12)
	delay 5
	...
	call HealingEffect
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG, 1, 12, 0, RGB(31, 22, 12)
	waitforvisualfinish
	clearmonbg ANIM_DEF_PARTNER
	blendoff
	end
...
Move_TIDAL_CRASH:
	...
	jumprettrue TidalCrashAgainstPlayer
...
TidalCrashContinue:
	...
	waitforvisualfinish
	playsewithpan SE_M_TAKE_DOWN, SOUND_PAN_ATTACKER
	createsprite gVerticalDipSpriteTemplate, ANIM_ATTACKER, 2, 18, 1, ANIM_ATTACKER
	waitforvisualfinish
	playsewithpan SE_M_TAKE_DOWN, SOUND_PAN_ATTACKER
	createsprite gVerticalDipSpriteTemplate, ANIM_ATTACKER, 2, 18, 1, ANIM_ATTACKER
	waitforvisualfinish
	delay 5
	createsprite gVerticalDipSpriteTemplate, ANIM_ATTACKER, 2, 6, 3, ANIM_ATTACKER
	createsprite gVerticalDipSpriteTemplate, ANIM_TARGET, 2, 18, 1, ANIM_TARGET
	createvisualtask AnimTask_ShakeMonInPlace, 5, ANIM_TARGET, 4, 0, 30, 1
	playsewithpan SE_M_WATERFALL, SOUND_PAN_TARGET
	createsprite gWaterHitSplatSpriteTemplate, ANIM_ATTACKER, 3, 0, -12, ANIM_TARGET, 1
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, -12
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, -12
	delay 2
	createsprite gWaterHitSplatSpriteTemplate, ANIM_ATTACKER, 3, 0, -9, ANIM_TARGET, 1
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, -9
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, -9
	delay 2
	createsprite gWaterHitSplatSpriteTemplate, ANIM_ATTACKER, 3, 0, -6, ANIM_TARGET, 1
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, -6
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, -6
	delay 2
	createsprite gWaterHitSplatSpriteTemplate, ANIM_ATTACKER, 3, 0, -3, ANIM_TARGET, 1
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, -3
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, -3
	delay 2
	...
	waitforvisualfinish
	delay 5
	createsprite gSlideMonToOffsetSpriteTemplate, ANIM_TARGET, 2, 1, 0, 0, 0, 3
	waitforvisualfinish
	clearmonbg ANIM_DEF_PARTNER
	delay 20
	restorebg
...
TidalCrashAgainstPlayer:
	fadetobg BG_HIGHSPEED_PLAYER
	goto TidalCrashContinue

Move_GLACIAL_TACKLE:
	loadspritegfx ANIM_TAG_ICE_CRYSTALS
	loadspritegfx ANIM_TAG_IMPACT
	loopsewithpan SE_M_HARDEN, SOUND_PAN_ATTACKER, 28, 2
	createvisualtask AnimTask_MetallicShine, 5, 1, 1, RGB(20, 25, 31)
	waitforvisualfinish
	playsewithpan SE_M_TAKE_DOWN, SOUND_PAN_ATTACKER
	delay 5
	createsprite gSlideMonToOffsetSpriteTemplate, ANIM_ATTACKER, 2, 0, 26, 0, 0, 5
...
Move_AQUA_TAIL:
	...
	setalpha 12, 8
	playsewithpan SE_M_TAKE_DOWN, SOUND_PAN_ATTACKER
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_ATTACKER, 2, 9, 0, RGB_BLUE
	delay 8
	playsewithpan SE_M_COMET_PUNCH, SOUND_PAN_ATTACKER
	createsprite gSlideMonToOffsetSpriteTemplate, ANIM_ATTACKER, 2, 0, 20, 3, 0, 4
	delay 1
...
Move_STRUGGLE_BUG:
	loadspritegfx ANIM_TAG_IMPACT
	loadspritegfx ANIM_TAG_MOVEMENT_WAVES
	createvisualtask AnimTask_BlendParticle, 5, ANIM_TAG_MOVEMENT_WAVES, 0, 6, 6, RGB_GREEN
	monbg ANIM_TARGET
	setalpha 12, 8
	createvisualtask AnimTask_ShakeMonInPlace, 2, ANIM_ATTACKER, 3, 0, 12, 4
	createsprite gMovementWavesSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, 2
...
Move_CAPTIVATE:
	...
	createvisualtask AnimTask_RockMonBackAndForth, 5, ANIM_ATTACKER, 2, 0
	createsprite gPinkHeart2SpriteTemplate, ANIM_ATTACKER, 3, 0, 20
	playsewithpan SE_M_CHARM, SOUND_PAN_ATTACKER
	delay 15
	createsprite gPinkHeart2SpriteTemplate, ANIM_ATTACKER, 3, -20, 20
	playsewithpan SE_M_CHARM, SOUND_PAN_ATTACKER
	delay 15
	createsprite gPinkHeart2SpriteTemplate, ANIM_ATTACKER, 3, 20, 20
	playsewithpan SE_M_CHARM, SOUND_PAN_ATTACKER
...
ScatteredWaterHitEffect:
	...
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, 10
	delay 2
	createsprite gWaterHitSplatSpriteTemplate, ANIM_ATTACKER, 3, 7, 13, ANIM_TARGET, 1
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 7, 13
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 7, 13
	delay 2
	createsprite gWaterHitSplatSpriteTemplate, ANIM_ATTACKER, 3, -15, 5, ANIM_TARGET, 1
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, -15, 5
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, -15, 5
	delay 2
	createsprite gWaterHitSplatSpriteTemplate, ANIM_ATTACKER, 3, -8, -10, ANIM_TARGET, 1
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, -8, -10
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, -8, -10
	delay 2
	createsprite gWaterHitSplatSpriteTemplate, ANIM_ATTACKER, 3, 10, -1, ANIM_TARGET, 1
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 10, -1
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 10, -1
	delay 2
	createsprite gWaterHitSplatSpriteTemplate, ANIM_ATTACKER, 3, 15, 15, ANIM_TARGET, 1
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 15, 15
	createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 15, 15
	return
...
Move_POISON_GALE:
	loadspritegfx ANIM_TAG_FLYING_DIRT
	createvisualtask AnimTask_BlendParticle, 5, ANIM_TAG_FLYING_DIRT, 0, 6, 6, RGB_MAGENTA
	createvisualtask AnimTask_LoadSandstormBackground, 5, TRUE
	createvisualtask AnimTask_BlendBackground, 6, 6, RGB_MAGENTA
	panse SE_M_HEAT_WAVE, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0
	delay 4
	createvisualtask AnimTask_MoveHeatWaveTargets, 5
	delay 12
...
Move_OMINOUS_WIND:
	loadspritegfx ANIM_TAG_FLYING_DIRT
	createvisualtask AnimTask_BlendParticle, 5, ANIM_TAG_FLYING_DIRT, 0, 6, 6, RGB(10, 5, 20)
	createvisualtask AnimTask_LoadSandstormBackground, 5, TRUE
	createvisualtask AnimTask_BlendBackground, 6, 6, RGB(10, 5, 20)
	panse SE_M_HEAT_WAVE, SOUND_PAN_ATTACKER, SOUND_PAN_TARGET, +2, 0
	delay 4
	createvisualtask AnimTask_MoveHeatWaveTargets, 5
	delay 12
...
Move_MAGNET_RISE:
	...
	delay 25
	createvisualtask AnimTask_GetAttackerSide, 2
	jumpretfalse MagnetRiseContinue
	createsprite gSlideMonToOffsetSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, -10, 0, 25
MagnetRiseContinue:
	playsewithpan SE_M_CHARGE, SOUND_PAN_ATTACKER
	delay 20
	playsewithpan SE_M_CHARGE, SOUND_PAN_ATTACKER
...
Move_STORM_BREAK:
	...
	loadspritegfx ANIM_TAG_WATER_IMPACT
	loadspritegfx ANIM_TAG_TORN_METAL
	choosetwoturnanim StormBreakNormal, StormBreakShatteredWall
...
StormBreakNormal:
	...
	loopsewithpan SE_M_HEADBUTT, SOUND_PAN_ATTACKER, 8, 2
	waitforvisualfinish
    createvisualtask AnimTask_ShakeMonInPlace, 5, ANIM_TARGET, 8, 0, 16, 1
    playsewithpan SE_M_WATERFALL, SOUND_PAN_TARGET
    createsprite gWaterHitSplatSpriteTemplate, ANIM_ATTACKER, 5, 0, 0, ANIM_TARGET, 1
    createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, 0
    createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, 0
    createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, 0
    createsprite gSmallDriftingBubblesSpriteTemplate, ANIM_ATTACKER, 4, 0, 0
...
StormBreakShatteredWall:
	fadetobg BG_THUNDER
	waitbgfadeout
	createvisualtask AnimTask_StartSlidingBg, 5, -256, 0, 1, -1
	waitbgfadein
	delay 8
	createsprite gBrickBreakWallSpriteTemplate, ANIM_ATTACKER, 3, ANIM_TARGET, 0, 0, 45, 10
	delay 1
	createvisualtask AnimTask_FlailMovement, 2, ANIM_ATTACKER
    loopsewithpan SE_M_HEADBUTT, SOUND_PAN_ATTACKER, 8, 2
    waitforvisualfinish
...
Move_MAGNET_SHOCK:
	...
	playsewithpan SE_M_SCREECH, SOUND_PAN_ATTACKER
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG, 2, 4, 0, RGB_BLACK
	clearmonbg ANIM_DEF_PARTNER
	blendoff
	end
...
SandBlasterDirt:
	...
	createsprite gSandAttackDirtSpriteTemplate, ANIM_TARGET, 2, 15, 15, 20, 20, 5
	createsprite gSandAttackDirtSpriteTemplate, ANIM_TARGET, 2, 15, 15, 20, -20, -5
	createsprite gSandAttackDirtSpriteTemplate, ANIM_TARGET, 2, 15, 15, 20, 18, -4
	createsprite gSandAttackDirtSpriteTemplate, ANIM_TARGET, 2, 15, 15, 20, -18, 4
	createsprite gSandAttackDirtSpriteTemplate, ANIM_TARGET, 2, 15, 15, 20, 12, -8
	createsprite gSandAttackDirtSpriteTemplate, ANIM_TARGET, 2, 15, 15, 20, -12, 8
	delay 2
	return
...
Move_POWER_FANG:
	...
	createsprite gBasicHitSplatSpriteTemplate, ANIM_ATTACKER, 2, 0, 0, ANIM_TARGET, 2
	createvisualtask AnimTask_ShakeMon, 5, ANIM_TARGET, 0, 4, 7, 1
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_TARGET, 2, 9, 0, RGB_CYAN
	delay 10
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_TARGET, 2, 9, 0, RGB_MAGENTA
	delay 10
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_TARGET, 2, 9, 0, RGB_YELLOW
	waitforvisualfinish
	clearmonbg ANIM_TARGET
	blendoff
	delay 1
...
Move_MUD_BOMB:
	...
	loadspritegfx ANIM_TAG_MUD_SAND
	playsewithpan SE_M_BUBBLE3, SOUND_PAN_ATTACKER
	createsprite gMudProjectileSpriteTemplate, ANIM_TARGET, 2, 20, 0, 40, 0
	waitforvisualfinish
	createvisualtask AnimTask_ShakeMon, 5, ANIM_TARGET, 3, 0, 5, 1
	createvisualtask AnimTask_BlendColorCycle, 2, F_PAL_TARGET, 1, 2, 0, 12, RGB(15, 10, 10)
	playsewithpan SE_M_DIG, SOUND_PAN_TARGET
	waitforvisualfinish
	end
...
Move_HURRICANE:
	...
	loadspritegfx ANIM_TAG_IMPACT
	createvisualtask AnimTask_GetAttackerSide, 2
	jumprettrue HurricaneAgainstPlayer
	fadetobg BG_HIGHSPEED_OPPONENT
HurricaneContinue:
	waitbgfadeout
	createvisualtask AnimTask_StartSlidingBg, 5, -2304, 0, 1, -1
	...
	splitbgprio ANIM_TARGET
	setalpha 12, 8
	loopsewithpan SE_M_GUST, SOUND_PAN_TARGET, 24, 2
	createsprite gEllipticalGustSpriteTemplate, ANIM_ATTACKER, 2, 0, -16
	createvisualtask AnimTask_AnimateGustTornadoPalette, 5, 1, 70
	delay 12
	createvisualtask AnimTask_ShakeMon2, 5, ANIM_TARGET, 1, 0, 24, 1
	createsprite gEllipticalGustSpriteTemplate, ANIM_ATTACKER, 2, 0, -16
	delay 12
	createsprite gEllipticalGustSpriteTemplate, ANIM_ATTACKER, 2, 0, -16
	delay 10
...
HurricaneAgainstPlayer:
	fadetobg BG_HIGHSPEED_PLAYER
	goto HurricaneContinue
...
Move_DUST_DEVIL:
	...
	createvisualtask AnimTask_BlendParticle, 5, ANIM_TAG_GUST, 0, 6, 6, RGB(25, 13, 0)
	loopsewithpan SE_M_GUST, SOUND_PAN_TARGET, 24, 2
	createsprite gEllipticalGustSpriteTemplate, ANIM_ATTACKER, 2, 0, -16
	createvisualtask AnimTask_AnimateGustTornadoPalette, 5, 1, 70
	delay 12
...
Move_ARC_DRAIN:
	...
	setalpha 12, 8
	createsprite gSimplePaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG, 1, 0, 7, RGB_BLACK
	loopsewithpan SE_M_THUNDERBOLT2, SOUND_PAN_ATTACKER, 13, 5
	createvisualtask AnimTask_BlendColorCycle, 2, F_PAL_ATTACKER, 0, 6, 0, 11, RGB(31, 31, 0)
	call ArcDrainAbsorbEffect
	call ArcDrainAbsorbEffect
	call ArcDrainAbsorbEffect
	waitforvisualfinish
	createsprite gSimplePaletteBlendSpriteTemplate, ANIM_ATTACKER, 2, F_PAL_BG, 0, 7, 0, RGB_BLACK
...
ArcDrainAbsorbEffect:
	createsprite gPowerAbsorptionOrbSpriteTemplate, ANIM_ATTACKER, 2, 120, -30, 13
	createsprite gElectricitySpriteTemplate, ANIM_TARGET, 2, 5, 0, 5, 0
	delay 2
	createsprite gPowerAbsorptionOrbSpriteTemplate, ANIM_ATTACKER, 2, -105, -30, 13
	createsprite gElectricitySpriteTemplate, ANIM_TARGET, 2, -5, 10, 5, 1
	delay 2
	createsprite gPowerAbsorptionOrbSpriteTemplate, ANIM_ATTACKER, 2, 45, -120, 13
	createsprite gElectricitySpriteTemplate, ANIM_TARGET, 2, 15, 20, 5, 2
	delay 2
	createsprite gPowerAbsorptionOrbSpriteTemplate, ANIM_ATTACKER, 2, -30, -96, 13
	createsprite gElectricitySpriteTemplate, ANIM_TARGET, 2, -15, -10, 5, 0
	delay 2
	createsprite gPowerAbsorptionOrbSpriteTemplate, ANIM_ATTACKER, 2, 75, -60, 13
	createsprite gElectricitySpriteTemplate, ANIM_TARGET, 2, 25, 0, 5, 1
	delay 2
	createsprite gPowerAbsorptionOrbSpriteTemplate, ANIM_ATTACKER, 2, -120, -60, 13
	createsprite gElectricitySpriteTemplate, ANIM_TARGET, 2, -8, 8, 5, 2
	delay 2
	createsprite gPowerAbsorptionOrbSpriteTemplate, ANIM_ATTACKER, 2, 15, -120, 13
...
Move_HEX:
	...
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_TARGET, 2, 9, 0, RGB(12, 5, 20)
	waitforvisualfinish
	clearmonbg ANIM_DEF_PARTNER
	end
...
Move_SWEET_SCENT:
	...
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_BATTLERS_2, 2, 0, 16, RGB(31, 21, 21)
	call SweetScentEffect
	createvisualtask AnimTask_BlendBattleAnimPal, 10, F_PAL_BATTLERS_2, 1, 16, 0, RGB(31, 21, 21)
	waitforvisualfinish
	end
...
Move_SEED_BOMB:
	...
	loadspritegfx ANIM_TAG_EXPLOSION
	playsewithpan SE_M_VITAL_THROW, SOUND_PAN_ATTACKER
	createsprite gSeedProjectileSpriteTemplate, ANIM_TARGET, 2, 20, 0, 30, 0, -40, 0, 5
	delay 10
	playsewithpan SE_M_VITAL_THROW, SOUND_PAN_ATTACKER
	createsprite gSeedProjectileSpriteTemplate, ANIM_TARGET, 2, 20, 0, 30, 0, -60, 10, -5
	delay 10
	playsewithpan SE_M_VITAL_THROW, SOUND_PAN_ATTACKER
	createsprite gSeedProjectileSpriteTemplate, ANIM_TARGET, 2, 20, 0, 30, 0, -20, -10, -5
	delay 10
	createvisualtask AnimTask_ShakeMon2, 2, ANIM_TARGET, 4, 0, 16, 1
	createsprite gExplosionSpriteTemplate, ANIM_TARGET, 4, 6, 5, 1, 0
	playsewithpan SE_M_SELF_DESTRUCT, SOUND_PAN_TARGET
...
Move_TRAILBLAZER:
	...
	setalpha 12, 8
	createvisualtask AnimTask_GetAttackerSide, 2
	jumprettrue TrailblazerAgainstPlayer
	createsprite gHorizontalLungeSpriteTemplate, ANIM_ATTACKER, 2, 4, 4
	delay 6
	createsprite gFirePlumeSpriteTemplate, ANIM_ATTACKER, 2, 25, -12, 24, 0, 0, 0
	createsprite gFirePlumeSpriteTemplate, ANIM_ATTACKER, 2, 15, -12, 24, 0, 0, 0
	playsewithpan SE_M_FLAME_WHEEL2, SOUND_PAN_ATTACKER
	delay 10
	createsprite gFirePlumeSpriteTemplate, ANIM_ATTACKER, 2, 45, -24, 24, 0, 0, 0
	createsprite gFirePlumeSpriteTemplate, ANIM_ATTACKER, 2, 35, -24, 24, 0, 0, 0
	playsewithpan SE_M_FLAME_WHEEL2, SOUND_PAN_ATTACKER
	delay 10
	createsprite gFirePlumeSpriteTemplate, ANIM_ATTACKER, 2, 65, -36, 24, 0, 0, 0
	createsprite gFirePlumeSpriteTemplate, ANIM_ATTACKER, 2, 55, -36, 24, 0, 0, 0
	playsewithpan SE_M_FLAME_WHEEL2, SOUND_PAN_ATTACKER
	delay 10
	createsprite gFirePlumeSpriteTemplate, ANIM_ATTACKER, 2, 85, -48, 24, 0, 0, 0
	createsprite gFirePlumeSpriteTemplate, ANIM_ATTACKER, 2, 75, -48, 24, 0, 0, 0
	playsewithpan SE_M_FLAME_WHEEL2, SOUND_PAN_ATTACKER
	delay 10
	createsprite gFirePlumeSpriteTemplate, ANIM_ATTACKER, 2, 105, -60, 24, 0, 0, 0
	createsprite gFirePlumeSpriteTemplate, ANIM_ATTACKER, 2, 95, -60, 24, 0, 0, 0
	playsewithpan SE_M_FLAME_WHEEL2, SOUND_PAN_ATTACKER
	delay 10
	createvisualtask AnimTask_ShakeMon, 5, ANIM_TARGET, 12, 0, 20, 1
	waitforvisualfinish
