...
extern const u8 BattleScript_SunlightContinues[];
extern const u8 BattleScript_SunlightFaded[];
extern const u8 BattleScript_AshContinues[];
extern const u8 BattleScript_AshStopsFalling[];
extern const u8 BattleScript_OverworldWeatherStarts[];
extern const u8 BattleScript_DistortionContinues[];
extern const u8 BattleScript_DistortionEnds[];
...
extern const u8 BattleScript_SuccessForceOutAnim[];
...
extern const u8 BattleScript_ToxicSpikesOnTarget[];
extern const u8 BattleScript_RemoveToxicSpikes[];
...
extern const u8 BattleScript_MoveUsedIsHealBlocked[];
...
extern const u8 BattleScript_AttackForceOut[];
...
extern const u8 BattleScript_HydrationActivates[];
extern const u8 BattleScript_WeatherFormChanges[];
extern const u8 BattleScript_WeatherFormChangesLoop[];
extern const u8 BattleScript_CastformChange[];
extern const u8 BattleScript_DroughtActivates[];
extern const u8 BattleScript_AshVentActivates[];
extern const u8 BattleScript_BlackSmokeActivates[];
...
extern const u8 BattleScript_SLPPrevention[];
...
extern const u8 BattleScript_ItemCausedBurn[];
...
extern const u8 BattleScript_PkmnHasMoonPlate[];
...
extern const u8 BattleScript_ToxicSpikesOnFaintedBattler[];
...
extern const u8 BattleScript_BattleTowerTrainerBattleWon[];
extern const u8 BattleScript_KnockedDown[];
extern const u8 BattleScript_StatChangesCleared[];
