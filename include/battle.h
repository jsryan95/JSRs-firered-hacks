...
#define MOVE_TARGET_USER_OR_ALLY    (1 << 1)
...
struct ProtectStruct
{
    ...
    u32 usedHealBlockedMove:1;           // 0x10
    u32 flag_x20 : 1;           // 0x20
    u32 flag_x40 : 1;           // 0x40
    u32 flag_x80 : 1;           // 0x80
    u32 field3 : 8;
...
#define IS_MOVE_PHYSICAL(move)(gBattleMoves[move].category == CATEGORY_PHYSICAL)
#define IS_MOVE_SPECIAL(move)(gBattleMoves[move].category == CATEGORY_SPECIAL)
#define IS_MOVE_STATUS(move)(gBattleMoves[move].category == CATEGORY_STATUS)
