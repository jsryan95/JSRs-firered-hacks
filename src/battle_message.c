...
static const u8 sText_PkmnChangedType[] = _("{B_DEF_NAME_WITH_PREFIX} transformed\ninto the {B_BUFF1} type!");
static const u8 sText_PkmnFlinched[] = _("{B_ATK_NAME_WITH_PREFIX} flinched!");
static const u8 sText_PkmnRegainedHealth[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} regained\nhealth!");
...
static const u8 sText_ToxicSpikesScattered[] = _("TOXIC SPIKES were scattered\nall around the opponent's side!");
static const u8 sText_StealthRockSet[] = _("It scattered pointed stones\naround its opponent's team!");
...
static const u8 sText_PkmnAbsorbedToxicSpikes[] = _("{B_ACTIVE_NAME_WITH_PREFIX} cleared the\nTOXIC SPIKES!");
...
static const u8 sText_PkmnStatusNormal[] = _("{B_DEF_NAME_WITH_PREFIX}'s status\nreturned to normal!");
...
static const u8 sText_PkmnGaveAbility[] = _("{B_DEF_NAME_WITH_PREFIX} got\n{B_ATK_NAME_WITH_PREFIX}'s {B_ATK_ABILITY}!");
...
static const u8 sText_PkmnFriskedXAndFoundY[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} frisked {B_BUFF1}\nand found one {B_BUFF2}!");
...
static const u8 sText_PkmnsItemPopped[] = _("{B_DEF_NAME_WITH_PREFIX}'s\n{B_LAST_ITEM} popped!");
...
{
    [B_MSG_ABILITY_PREVENTS_MOVE_STATUS]    = STRINGID_PKMNSTAYEDAWAKEUSING,
    [B_MSG_ABILITY_PREVENTS_ABILITY_STATUS] = STRINGID_PKMNSXPREVENTSYSZ,
    [B_MSG_STATUS_HAD_NO_EFFECT]            = STRINGID_PKMNSXHADNOEFFECTONY
};
