...
static const struct TrainerMonNoItemDefaultMoves sParty_LassDonna[] = {
    {
        .iv = 0,
        .lvl = 6,
...
static const struct TrainerMonNoItemCustomMoves sParty_CamperLiam[] = {
    ...
    },
    {
        ...
        .moves = {MOVE_SCRATCH, MOVE_ROCK_TOMB, MOVE_SAND_ATTACK, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_BeautyJamie[] = {
    {
        .iv = 16,
        .lvl = 12,
...
// mt. moon
static const struct TrainerMonNoItemDefaultMoves sParty_GentlemanKent[] = {
    {
        .iv = 16,
        .lvl = 13,
        .species = SPECIES_SANDSHREW,
...
// route 4
static const struct TrainerMonNoItemDefaultMoves sParty_BirdKeeperStuart[] = {
    {
        .iv = 16,
        .lvl = 13,
        .species = SPECIES_PIDGEY,
...
static const struct TrainerMonNoItemCustomMoves sParty_LeaderMisty[] = {
    {
        ...
        .moves = {MOVE_PECK, MOVE_RAIN_DANCE, MOVE_FURY_ATTACK, MOVE_WATER_PULSE},
        .ability = 0,
    },
    {
        .iv = 48,
...
static const struct TrainerMonNoItemDefaultMoves sParty_CoolTrainerJasper[] = {
    {
        .iv = 64,
        .lvl = 21,
        .species = SPECIES_BULBASAUR,
...
static const struct TrainerMonNoItemDefaultMoves sParty_CoolTrainerSandy[] = {
    {
        .iv = 64,
        .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_GamerDirk[] = {
    {
        ...
        .moves = {MOVE_POUND, MOVE_DISABLE, MOVE_CONFUSION, MOVE_POISON_GAS},
    },
    {
        .iv = 32,
        .lvl = 18,
        .species = SPECIES_MR_MIME,
        .moves = {MOVE_DOUBLE_SLAP, MOVE_REFLECT, MOVE_CONFUSION, MOVE_MEDITATE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_SailorLeonard[] = {
    {
        ...
        .moves = {MOVE_WITHDRAW, MOVE_SUPERSONIC, MOVE_WATER_PULSE, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GentlemanTucker[] = {
    {
        ...
        .lvl = 24,
        .species = SPECIES_EEVEE,
        .moves = {MOVE_THUNDERBOLT, MOVE_QUICK_ATTACK, MOVE_BITE, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_LeaderLtSurge[] = {
    {
        ...
        .lvl = 24,
        .species = SPECIES_MAGNEMITE,
        .moves = {MOVE_SONIC_BOOM, MOVE_SWIFT, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE},
    },
    {
        .iv = 64,
        .lvl = 24,
        .species = SPECIES_ELEKID,
        .moves = {MOVE_SWIFT, MOVE_THUNDER_WAVE, MOVE_SHOCK_WAVE, MOVE_LOW_SWEEP},
    },
    {
        .iv = 64,
        .lvl = 26,
        .species = SPECIES_RAICHU,
        .moves = {MOVE_THUNDER_WAVE, MOVE_BRICK_BREAK, MOVE_SHOCK_WAVE, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_CamperChris[] = {
    {
        ...
        .lvl = 21,
        .species = SPECIES_PIKACHU,
        .moves = {MOVE_SHOCK_WAVE, MOVE_SLAM, MOVE_DOUBLE_TEAM, MOVE_THUNDER_WAVE},
    },
    {
        .iv = 48,
        .lvl = 21,
        .species = SPECIES_MANKEY,
        .moves = {MOVE_KARATE_CHOP, MOVE_FURY_SWIPES, MOVE_FOCUS_ENERGY, MOVE_NONE}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_PicnickerCaitlin[] = {
    {
        ...
        .moves = {MOVE_SWEET_KISS, MOVE_ENCORE, MOVE_POUND, MOVE_MAGICAL_LEAF},
    },
    {
        .iv = 48,
        .lvl = 25,
        .species = SPECIES_IGGLYBUFF,
        .moves = {MOVE_SING, MOVE_CHARM, MOVE_POUND, MOVE_NONE},
    },
    {
        .iv = 48,
        .lvl = 25,
        .species = SPECIES_PICHU,
        .moves = {MOVE_CHARM, MOVE_THUNDER_WAVE, MOVE_NASTY_PLOT, MOVE_THUNDER_SHOCK},
    },
    {
        .iv = 48,
        .lvl = 23,
        .species = SPECIES_SMOOCHUM,
        .moves = {MOVE_MEAN_LOOK, MOVE_CONFUSION, MOVE_SWEET_KISS, MOVE_POWDER_SNOW},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_HikerAlan[] = {
    ...
    },
    {
        ...
        .lvl = 21,
        .species = SPECIES_ONIX,
        .moves = {MOVE_RAGE, MOVE_ROCK_THROW, MOVE_BIND, MOVE_SCREECH},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_HikerAllen[] = {
    {
        ...
        .moves = {MOVE_POISON_STING, MOVE_DOUBLE_KICK, MOVE_FOCUS_ENERGY, MOVE_PECK},
    },
    {
        .iv = 48,
        .lvl = 18,
        .species = SPECIES_NIDOQUEEN,
        .moves = {MOVE_POISON_STING, MOVE_DOUBLE_KICK, MOVE_TAIL_WHIP, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_PokemaniacHerman[] = {
    {
        ...
        .lvl = 22,
        .species = SPECIES_EEVEE,
        .moves = {MOVE_QUICK_ATTACK, MOVE_SAND_ATTACK, MOVE_THUNDERBOLT, MOVE_NONE},
    },
    {
        .iv = 48,
        .lvl = 22,
        .species = SPECIES_EEVEE,
        .moves = {MOVE_QUICK_ATTACK, MOVE_SAND_ATTACK, MOVE_FLAMETHROWER, MOVE_NONE},
    },
    {
        .iv = 48,
        .lvl = 22,
        .species = SPECIES_EEVEE,
        .moves = {MOVE_QUICK_ATTACK, MOVE_SAND_ATTACK, MOVE_ICE_BEAM, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_SuperNerdLeslie[] = {
    {
        ...
        .lvl = 26,
        .species = SPECIES_KOFFING,
        .moves = {MOVE_OMINOUS_WIND, MOVE_SMOKESCREEN, MOVE_SMOG, MOVE_SELF_DESTRUCT},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_BikerRicardo[] = {
    {
        ...
        .lvl = 23,
        .species = SPECIES_KOFFING,
        .moves = {MOVE_SELF_DESTRUCT, MOVE_SMOG, MOVE_PAYBACK, MOVE_POISON_GAS},
    },
    {
        .iv = 48,
        .lvl = 23,
        .species = SPECIES_KOFFING,
        .moves = {MOVE_OMINOUS_WIND, MOVE_PAYBACK, MOVE_SMOG, MOVE_HAZE},
    },
    {
        .iv = 48,
        .lvl = 24,
        .species = SPECIES_CLEFAIRY,
        .moves = {MOVE_METRONOME, MOVE_SING, MOVE_DOUBLE_SLAP, MOVE_WAKE_UP_SLAP},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TeamRocketGrunt10[] = {
    {
        ...
        .lvl = 26,
        .species = SPECIES_GRIMER,
        .moves = {MOVE_POISON_GAS, MOVE_SLUDGE, MOVE_DISABLE, MOVE_MUD_BOMB},
    },
    {
        .iv = 48,
        .lvl = 26,
        .species = SPECIES_KOFFING,
        .moves = {MOVE_SMOG, MOVE_OMINOUS_WIND, MOVE_POISON_GAS, MOVE_SMOKESCREEN},
    },
    {
        .iv = 48,
        .lvl = 26,
        .species = SPECIES_KOFFING,
        .moves = {MOVE_SMOG, MOVE_OMINOUS_WIND, MOVE_PAYBACK, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TeamRocketGrunt12[] = {
    {
        ...
        .lvl = 27,
        .species = SPECIES_GOLBAT,
        .moves = {MOVE_HAZE, MOVE_AIR_CUTTER, MOVE_CONFUSE_RAY, MOVE_BITE},
    },
    {
        .iv = 48,
        .lvl = 27,
        .species = SPECIES_HAUNTER,
        .moves = {MOVE_HEX, MOVE_CURSE, MOVE_CONFUSE_RAY, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TeamRocketGrunt13[] = {
    {
        ...
        .moves = {MOVE_BITE, MOVE_FIRE_FANG, MOVE_EMBARGO, MOVE_HOWL},
    },
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_GentlemanEmile[] = {
    {
        .iv = 48,
        .lvl = 26,
        .species = SPECIES_GROWLITHE,
...
static const struct TrainerMonNoItemCustomMoves sParty_CooltrainerMary[] = {
    {
        ...
        .lvl = 27,
        .species = SPECIES_PARASECT,
        .moves = {MOVE_SPORE, MOVE_SLASH, MOVE_FURY_CUTTER, MOVE_SUNNY_DAY},
    },
    {
        .iv = 80,
        .lvl = 27,
        .species = SPECIES_CLEFABLE,
        .moves = {MOVE_DOUBLE_SLAP, MOVE_SOLAR_BEAM, MOVE_COSMIC_POWER, MOVE_SUNNY_DAY},
    },
    {
        .iv = 80,
        .lvl = 27,
        .species = SPECIES_GLOOM,
        .moves = {MOVE_MUD_BOMB, MOVE_SLEEP_POWDER, MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_LeaderErika[] = {
    {
        ...
        .moves = {MOVE_STUN_SPORE, MOVE_RAIN_DANCE, MOVE_NATURAL_GIFT, MOVE_GIGA_DRAIN},
    ...
    },
    {
        ...
        .lvl = 30,
        .species = SPECIES_TANGELA,
        .moves = {MOVE_POISON_POWDER, MOVE_BIND, MOVE_NATURAL_GIFT, MOVE_GIGA_DRAIN},
    ...
    },
    {
        ...
        .moves = {MOVE_SLEEP_POWDER, MOVE_ACID, MOVE_STOCKPILE, MOVE_GIGA_DRAIN},
...
static const struct TrainerMonNoItemCustomMoves sParty_BikerLao[] = {
    {
        ...
        .lvl = 32,
        .species = SPECIES_GRIMER,
        .moves = {MOVE_MUD_BOMB, MOVE_MINIMIZE, MOVE_SLUDGE, MOVE_DISABLE},
    },
    {
        .iv = 64,
        .lvl = 32,
        .species = SPECIES_KOFFING,
        .moves = {MOVE_SMOKESCREEN, MOVE_OMINOUS_WIND, MOVE_SMOG, MOVE_PAYBACK},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_BikerVirgil[] = {
    {
        ...
        .moves = {MOVE_WING_ATTACK, MOVE_PURSUIT, MOVE_LEER, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_CueBallJamal[] = {
    {
        ...
        .lvl = 31,
        .species = SPECIES_MANKEY,
        .moves = {MOVE_LOW_KICK, MOVE_ASSURANCE, MOVE_SWAGGER, MOVE_ROCK_SLIDE},
    },
    {
        .iv = 64,
        .lvl = 31,
        .species = SPECIES_MANKEY,
        .moves = {MOVE_LOW_KICK, MOVE_ASSURANCE, MOVE_SWAGGER, MOVE_PUNISHMENT},
    },
    {
        .iv = 64,
        .lvl = 31,
        .species = SPECIES_MACHAMP,
        .moves = {MOVE_FORESIGHT, MOVE_LEER, MOVE_VITAL_THROW, MOVE_LOW_KICK},
    },
    {
        .iv = 64,
        .lvl = 31,
...
static const struct TrainerMonNoItemCustomMoves sParty_BikerJaxon[] = {
    {
        ...
        .lvl = 33,
        .species = SPECIES_WEEZING,
        .moves = {MOVE_SMOG, MOVE_OMINOUS_WIND, MOVE_SMOKESCREEN, MOVE_HAZE},
    },
    {
        .iv = 64,
        .lvl = 33,
        .species = SPECIES_MUK,
        .moves = {MOVE_SLUDGE, MOVE_MUD_BOMB, MOVE_SCREECH, MOVE_MINIMIZE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_CamperJustin[] = {
    {
        ...
        .lvl = 29,
        .species = SPECIES_BEEDRILL,
        .moves = {MOVE_TOXIC_SPIKES, MOVE_TWINEEDLE, MOVE_PURSUIT, MOVE_NONE},
    },
    {
        .iv = 64,
        .lvl = 29,
        .species = SPECIES_SNORLAX,
        .moves = {MOVE_CIRCLE_THROW, MOVE_CRUNCH, MOVE_NONE, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_PicnickerSusie[] = {
    {
        ...
        .lvl = 28,
        .species = SPECIES_PIDGEOTTO,
        .moves = {MOVE_WHIRLWIND, MOVE_WING_ATTACK, MOVE_QUICK_ATTACK, MOVE_FEATHER_DANCE},
    },
    {
        .iv = 64,
        .lvl = 28,
        .species = SPECIES_PERSIAN,
        .moves = {MOVE_SCREECH, MOVE_FURY_SWIPES, MOVE_PROTECT, MOVE_SWAGGER},
    },
    {
        .iv = 64,
        .lvl = 28,
        .species = SPECIES_RATICATE,
        .moves = {MOVE_SUPER_FANG, MOVE_SCARY_FACE, MOVE_PURSUIT, MOVE_HYPER_FANG},
    },
    {
        .iv = 64,
        .lvl = 28,
        .species = SPECIES_RAICHU,
        .moves = {MOVE_SPARK, MOVE_SLAM, MOVE_NONE, MOVE_NONE},
    },
    {
        .iv = 64,
        .lvl = 28,
        .species = SPECIES_SANDSLASH,
        .moves = {MOVE_FURY_CUTTER, MOVE_ROLLOUT, MOVE_SANDSTORM, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_BikerJared[] = {
    {
        ...
        .lvl = 32,
        .species = SPECIES_KOFFING,
        .moves = {MOVE_SELF_DESTRUCT, MOVE_SMOG, MOVE_OMINOUS_WIND, MOVE_SMOKESCREEN},
    },
    {
        .iv = 64,
        .lvl = 32,
        .species = SPECIES_KOFFING,
        .moves = {MOVE_SMOKESCREEN, MOVE_OMINOUS_WIND, MOVE_SMOG, MOVE_NONE},
    },
    {
        .iv = 64,
        .lvl = 32,
        .species = SPECIES_DROWZEE,
        .moves = {MOVE_DISABLE, MOVE_FAINT_ATTACK, MOVE_PSYCH_UP, MOVE_FUTURE_SIGHT},
    },
};

static const struct TrainerMonNoItemDefaultMoves sParty_GentlemanRobert[] = {
    {
        .iv = 64,
        .lvl = 35,
...
// route 14
static const struct TrainerMonNoItemDefaultMoves sParty_CamperCarter[] = {
    {
        .iv = 64,
        .lvl = 31,
        .species = SPECIES_GRAVELER,
...
static const struct TrainerMonNoItemCustomMoves sParty_CoolTrainerLizzy[] = {
    {
        .iv = 80,
        .lvl = 36,
        .species = SPECIES_MR_MIME,
        .moves = {MOVE_REFLECT, MOVE_MEDITATE, MOVE_BATON_PASS, MOVE_PSYCHIC}
    },
    {
        .iv = 80,
        .lvl = 36,
        .species = SPECIES_TAUROS,
        .moves = {MOVE_STRENGTH, MOVE_PURSUIT, MOVE_EARTHQUAKE, MOVE_NONE}
    },
};

static const struct TrainerMonNoItemCustomMoves sParty_ExpertDonald[] = {
    {
        .iv = 80,
        .lvl = 37,
        .species = SPECIES_POLIWRATH,
        .moves = {MOVE_DYNAMIC_PUNCH, MOVE_BODY_SLAM, MOVE_SURF, MOVE_NONE}
    },
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_ExpertEsme[] = {
    {
        .iv = 80,
        .lvl = 37,
        .species = SPECIES_DUSCLOPS,
...
static const struct TrainerMonNoItemCustomMoves sParty_ScientistConnor[] = {
    {
        ...
        .lvl = 40,
        .species = SPECIES_NOSEPASS,
        .moves = {MOVE_REST, MOVE_SLEEP_TALK, MOVE_ZAP_CANNON, MOVE_EARTHQUAKE},
    },
    {
        .iv = 80,
        .lvl = 40,
        .species = SPECIES_HAUNTER,
        .moves = {MOVE_HYPNOSIS, MOVE_DREAM_EATER, MOVE_SHADOW_BALL, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_ScientistJose[] = {
    {
        ...
        .moves = {MOVE_DISCHARGE, MOVE_CONVERSION_2, MOVE_RECOVER, MOVE_ICE_BEAM},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TeamRocketGruntExtra1[] = {
    {
        .iv = 80,
        .lvl = 42,
        .species = SPECIES_HOUNDOOM,
        .moves = {MOVE_SUNNY_DAY, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_ScientistEd[] = {
    {
        ...
        .lvl = 44,
        .species = SPECIES_VIBRAVA,
        .moves = {MOVE_SANDSTORM, MOVE_DUST_DEVIL, MOVE_ROCK_SLIDE, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TeamRocketGrunt40[] = {
    {
        ...
        .lvl = 42,
        .species = SPECIES_POLITOED,
        .moves = {MOVE_WHIRLPOOL, MOVE_BODY_SLAM, MOVE_BOUNCE, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_SwimmerMaleBarry[] = {
    {
        ...
        .lvl = 40,
        .species = SPECIES_STARMIE,
        .moves = {MOVE_WHIRLPOOL, MOVE_WATER_WHEEL, MOVE_LIGHT_SCREEN, MOVE_POWER_GEM},
    },
    {
        .iv = 96,
        .lvl = 40,
        .species = SPECIES_CLOYSTER,
        .moves = {MOVE_IRON_DEFENSE, MOVE_BRINE, MOVE_CLAMP, MOVE_ICE_BEAM},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_ScientistIvan[] = {
    {
        ...
        .moves = {MOVE_FIRE_PUNCH, MOVE_BULLET_PUNCH, MOVE_THUNDER_PUNCH, MOVE_LOW_SWEEP},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_BurglarLewis[] = {
    {
        ...
        .lvl = 40,
        .species = SPECIES_MAGMAR,
        .moves = {MOVE_THUNDER_PUNCH, MOVE_SUNNY_DAY, MOVE_FIRE_PUNCH, MOVE_INCINERATE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_BikerGoon[] = {
    {
        ...
        .lvl = 42,
        .species = SPECIES_HOUNDOOM,
        .moves = {MOVE_CRUNCH, MOVE_EMBARGO, MOVE_FIRE_FANG, MOVE_NONE},
    },
    {
        .iv = 96,
        .lvl = 42,
        .species = SPECIES_MUK,
        .moves = {MOVE_MUD_BOMB, MOVE_ACID_ARMOR, MOVE_SLUDGE_BOMB, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_BikerGoon2[] = {
    {
        ...
        .lvl = 42,
        .species = SPECIES_WEEZING,
        .moves = {MOVE_HAZE, MOVE_POISON_GALE, MOVE_INCINERATE, MOVE_MEMENTO},
    },
    {
        .iv = 96,
        .lvl = 42,
        .species = SPECIES_VENOMOTH,
        .moves = {MOVE_QUIVER_DANCE, MOVE_BUG_BUZZ, MOVE_NONE, MOVE_NONE},
        .ability = 1,
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_CueBallPaxton[] = {
    {
        .iv = 96,
        .lvl = 45,
        .species = SPECIES_CLEFABLE,
    ...
    },
    {
        ...
        .moves = {MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_NONE, MOVE_NONE},
    },
};
...
// kindle road
static const struct TrainerMonNoItemCustomMoves sParty_SwimmerFemaleAbigail[] = {
    {
        .iv = 96,
        .lvl = 47,
        .species = SPECIES_EXEGGUTOR,
        .moves = {MOVE_HYPNOSIS, MOVE_STOMP, MOVE_PSYSHOCK, MOVE_SURF}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_SwimmerMaleFinn[] = {
    {
        .iv = 96,
        .lvl = 46,
        .species = SPECIES_STARMIE,
        .moves = {MOVE_LIGHT_SCREEN, MOVE_POWER_GEM, MOVE_COSMIC_POWER, MOVE_HYDRO_PUMP},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_LeaderBlaine[] = {
    ...
    },
    {
        ...
        .lvl = 51,
        .species = SPECIES_FLAREON,
        .moves = {MOVE_OVERHEAT, MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_FLARE_BLITZ},
        .heldItem = ITEM_CHOICE_SPECS,
        .ability = 1,
    },
    {
...
static const struct TrainerMonNoItemCustomMoves sParty_TamerCole[] = {
    {
        ...
        .lvl = 47,
        .species = SPECIES_ARBOK,
        .moves = {MOVE_POISON_FANG, MOVE_CRUNCH, MOVE_GASTRO_ACID, MOVE_COIL},
    },
    {
        .iv = 112,
        .lvl = 47,
        .species = SPECIES_TAUROS,
        .moves = {MOVE_WORK_UP, MOVE_SWAGGER, MOVE_ZEN_HEADBUTT, MOVE_EARTHQUAKE},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_CooltrainerSamuel[] = {
    {
        ...
        .lvl = 47,
        .species = SPECIES_SANDSLASH,
        .moves = {MOVE_SLASH, MOVE_SAND_TOMB, MOVE_SANDSTORM, MOVE_DIG},
    },
    {
        .iv = 128,
        .lvl = 47,
        .species = SPECIES_NIDORINO,
        .moves = {MOVE_CAPTIVATE, MOVE_POISON_JAB, MOVE_DOUBLE_KICK, MOVE_TOXIC},
        .heldItem = ITEM_EVIOLITE,
    },
    {
        .iv = 128,
        .lvl = 47,
        .species = SPECIES_SANDSLASH,
        .moves = {MOVE_SLASH, MOVE_SAND_TOMB, MOVE_GYRO_BALL, MOVE_DIG},
    },
    {
        .iv = 128,
        .lvl = 47,
        .species = SPECIES_RHYHORN,
        .moves = {MOVE_TAKE_DOWN, MOVE_STONE_EDGE, MOVE_BULLDOZE, MOVE_SCARY_FACE},
        .heldItem = ITEM_EVIOLITE,
    },
    {
        .iv = 128,
        .lvl = 47,
        .species = SPECIES_NIDOKING,
        .moves = {MOVE_THRASH, MOVE_DOUBLE_KICK, MOVE_POISON_JAB, MOVE_CHIP_AWAY},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_CooltrainerYuji[] = {
    ...
    },
    {
        ...
        .lvl = 47,
        .species = SPECIES_ONIX,
        .moves = {MOVE_DIG, MOVE_SANDSTORM, MOVE_ROCK_SLIDE, MOVE_SAND_TOMB},
        .heldItem = ITEM_EVIOLITE,
    },
    {
        .iv = 128,
        .lvl = 47,
        .species = SPECIES_GRAVELER,
        .moves = {MOVE_ROCK_BLAST, MOVE_MAGNITUDE, MOVE_MUD_SPORT, MOVE_EXPLOSION},
        .heldItem = ITEM_EVIOLITE,
    },
    {
        .iv = 128,
        .lvl = 47,
        .species = SPECIES_MAROWAK,
        .moves = {MOVE_BONEMERANG, MOVE_IRON_HEAD, MOVE_RETALIATE, MOVE_RAGE},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_CooltrainerWarren[] = {
    {
        ...
        .lvl = 47,
        .species = SPECIES_MAROWAK,
        .moves = {MOVE_BONEMERANG, MOVE_GROWL, MOVE_DESPAIR, MOVE_ROCK_TOMB},
    },
    {
        .iv = 128,
        .lvl = 47,
        .species = SPECIES_MAROWAK,
        .moves = {MOVE_BONEMERANG, MOVE_RETALIATE, MOVE_IRON_HEAD, MOVE_NONE},
    },
    {
        .iv = 128,
        .lvl = 47,
        .species = SPECIES_NIDORINA,
        .moves = {MOVE_CRUNCH, MOVE_TOXIC, MOVE_CAPTIVATE, MOVE_DOUBLE_KICK},
        .heldItem = ITEM_EVIOLITE,
    },
    {
        .iv = 128,
    ...
    },
    {
        ...
        .lvl = 47,
        .species = SPECIES_NIDOQUEEN,
        .moves = {MOVE_BODY_SLAM, MOVE_DOUBLE_KICK, MOVE_CRUNCH, MOVE_CHIP_AWAY},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_LeaderGiovanni[] = {
    {
        ...
        .lvl = 53,
        .species = SPECIES_NIDOQUEEN,
        .moves = {MOVE_BODY_SLAM, MOVE_DOUBLE_KICK, MOVE_TOXIC_SPIKES, MOVE_EARTHQUAKE},
    ...
    },
    {
        ...
        .moves = {MOVE_HYPER_BEAM, MOVE_DUST_DEVIL, MOVE_BUG_BUZZ, MOVE_EARTHQUAKE},
        .heldItem = ITEM_CHOICE_SPECS,
    },
    {
        .iv = 144,
        ...
        .moves = {MOVE_MIST, MOVE_BODY_SLAM, MOVE_GLACIAL_TACKLE, MOVE_EARTHQUAKE},
    ...
    },
    {
        ...
        .lvl = 53,
        .species = SPECIES_KANGASKHAN,
        .moves = {MOVE_WORK_UP, MOVE_MEGA_KICK, MOVE_REVERSAL, MOVE_EARTHQUAKE},
    ...
    },
    {
        ...
        .lvl = 56,
        .species = SPECIES_RHYDON,
        .moves = {MOVE_TAKE_DOWN, MOVE_STONE_EDGE, MOVE_MEGAHORN, MOVE_EARTHQUAKE},
        .heldItem = ITEM_HEAVY_BAND,
        .ability = 1,
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalRoute22LateSquirtle[] = {
    {
        ...
        .lvl = 49,
        .species = SPECIES_PIDGEOT,
        .moves = {MOVE_FEATHER_DANCE, MOVE_ROOST, MOVE_BRAVE_BIRD, MOVE_WHIRLWIND},
    },
    {
        .iv = 144,
        .lvl = 47,
        .species = SPECIES_MAGNETON,
        .moves = {MOVE_THUNDER_WAVE, MOVE_DISCHARGE, MOVE_MAGNET_RISE, MOVE_FLASH_CANNON},
    },
    {
        .iv = 144,
        .lvl = 47,
        .species = SPECIES_ARCANINE,
        .moves = {MOVE_FLARE_BLITZ, MOVE_REVERSAL, MOVE_THUNDER_FANG, MOVE_AGILITY},
    },
    {
        .iv = 144,
        .lvl = 47,
        .species = SPECIES_EXEGGUTOR,
        .moves = {MOVE_HYPNOSIS, MOVE_PSYCHO_BREAK, MOVE_REFLECT, MOVE_GIGA_DRAIN},
    },
    {
        .iv = 144,
        .lvl = 49,
    ...
    },
    {
        ...
        .lvl = 55,
        .species = SPECIES_BLASTOISE,
        .moves = {MOVE_HYDRO_PUMP, MOVE_RAIN_DANCE, MOVE_YAWN, MOVE_EARTHQUAKE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalRoute22LateBulbasaur[] = {
    ...
    },
    {
        ...
        .lvl = 47,
        .species = SPECIES_GYARADOS,
        .moves = {MOVE_DRAGON_DANCE, MOVE_THRASH, MOVE_AQUA_TAIL, MOVE_FIRE_FANG},
    },
    {
        .iv = 144,
        .lvl = 47,
    ...
    },
    {
        ...
        .lvl = 55,
        .species = SPECIES_VENUSAUR,
        .moves = {MOVE_SLEEP_POWDER, MOVE_PETAL_DANCE, MOVE_GROWTH, MOVE_SYNTHESIS},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalRoute22LateCharmander[] = {
    ...
    },
    {
        ...
        .lvl = 55,
        .species = SPECIES_CHARIZARD,
        .moves = {MOVE_FLAMETHROWER, MOVE_INCINERATE, MOVE_FIRE_SPIN, MOVE_FLY},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_CooltrainerNaomi[] = {
    {
        ...
        .lvl = 47,
        .species = SPECIES_PERSIAN,
        .moves = {MOVE_SLASH, MOVE_SCREECH, MOVE_NIGHT_SLASH, MOVE_TAUNT},
    },
    {
        .iv = 144,
        .lvl = 47,
        .species = SPECIES_PONYTA,
        .moves = {MOVE_AGILITY, MOVE_TAKE_DOWN, MOVE_FIRE_BLAST, MOVE_BOUNCE},
        .heldItem = ITEM_EVIOLITE,
    },
    {
        .iv = 144,
    ...
    },
    {
        ...
        .lvl = 47,
        .species = SPECIES_VULPIX,
        .moves = {MOVE_FLAMETHROWER, MOVE_CAPTIVATE, MOVE_EXTRASENSORY, MOVE_CONFUSE_RAY},
        .heldItem = ITEM_EVIOLITE,
    },
    {
        .iv = 144,
        .lvl = 47,
        .species = SPECIES_NINETALES,
        .moves = {MOVE_SAFEGUARD, MOVE_WILL_O_WISP, MOVE_FLAMETHROWER, MOVE_HEX},
    },
};

static const struct TrainerMonItemDefaultMoves sParty_CooltrainerRolando[] = {
    {
        .iv = 144,
        .lvl = 47,
        .species = SPECIES_RATICATE,
...
static const struct TrainerMonNoItemCustomMoves sParty_CooltrainerGeorge[] = {
    {
        ...
        .lvl = 51,
        .species = SPECIES_EXEGGUTOR,
        .moves = {MOVE_BARRAGE, MOVE_CONFUSION, MOVE_STUN_SPORE, MOVE_HYPNOSIS},
    },
    {
        .iv = 144,
        .lvl = 51,
        .species = SPECIES_SANDSLASH,
        .moves = {MOVE_FURY_SWIPES, MOVE_SPIKES, MOVE_FURY_CUTTER, MOVE_SAND_ATTACK},
    },
    {
        .iv = 144,
        .lvl = 51,
    ...
    },
    {
        ...
        .lvl = 51,
        .species = SPECIES_ELECTRODE,
        .moves = {MOVE_CHARGE_BEAM, MOVE_SONIC_BOOM, MOVE_CHARGE, MOVE_MIRROR_COAT},
    },
    {
        .iv = 144,
        .lvl = 51,
        .species = SPECIES_ARCANINE,
        .moves = {MOVE_FIRE_FANG, MOVE_ROAR, MOVE_LEER, MOVE_TAKE_DOWN},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_CooltrainerAlexa[] = {
    {
        ...
        .lvl = 51,
        .species = SPECIES_CLEFAIRY,
        .moves = {MOVE_LIGHT_SCREEN, MOVE_METEOR_MASH, MOVE_STAR_SHOOTER, MOVE_ENCORE},
        .heldItem = ITEM_EVIOLITE,
    },
    {
        .iv = 144,
        .lvl = 51,
        .species = SPECIES_JIGGLYPUFF,
        .moves = {MOVE_SING, MOVE_BODY_SLAM, MOVE_REVENGE, MOVE_DISABLE},
        .heldItem = ITEM_EVIOLITE,
    },
    {
        .iv = 144,
        .lvl = 51,
        .species = SPECIES_GLALIE,
        .moves = {MOVE_HAIL, MOVE_HEADBUTT, MOVE_BLIZZARD, MOVE_FLASH_FREEZE},
    },
    {
        .iv = 144,
        .lvl = 51,
        .species = SPECIES_DEWGONG,
        .moves = {MOVE_ICE_BEAM, MOVE_AQUA_RING, MOVE_REST, MOVE_AURORA_BEAM},
    },
    {
        .iv = 144,
        .lvl = 51,
        .species = SPECIES_CHANSEY,
        .moves = {MOVE_SING, MOVE_ENERGY_BALL, MOVE_SOFT_BOILED, MOVE_REFRESH},
        .heldItem = ITEM_EVIOLITE,
    },
};

static const struct TrainerMonItemDefaultMoves sParty_CooltrainerCaroline[] = {
    {
        .iv = 144,
        .lvl = 51,
        .species = SPECIES_BELLSPROUT,
...
static const struct TrainerMonItemCustomMoves sParty_CooltrainerColby[] = {
    {
        ...
        .lvl = 51,
        .species = SPECIES_KINGLER,
        .moves = {MOVE_KNOCK_OFF, MOVE_BUBBLE_GUARD, MOVE_CRABHAMMER, MOVE_FLAIL}
    },
    {
        .iv = 144,
        .lvl = 51,
        .species = SPECIES_POLIWHIRL,
        .moves = {MOVE_BELLY_DRUM, MOVE_BODY_SLAM, MOVE_HYPNOSIS, MOVE_WAKE_UP_SLAP},
        .heldItem = ITEM_EVIOLITE,
    },
    {
        .iv = 144,
        .lvl = 51,
        .species = SPECIES_TENTACRUEL,
        .moves = {MOVE_REFLECT, MOVE_NEUROTOXIN, MOVE_HYDRO_PUMP, MOVE_SUPERSONIC},
    },
    {
        .iv = 144,
        .lvl = 51,
        .species = SPECIES_SEADRA,
        .moves = {MOVE_FOCUS_ENERGY, MOVE_CAPTIVATE, MOVE_SCALD, MOVE_DRAGON_DANCE},
        .heldItem = ITEM_EVIOLITE,
    },
    {
        .iv = 144,
        .lvl = 51,
        .species = SPECIES_BLASTOISE,
        .moves = {MOVE_IRON_DEFENSE, MOVE_SURF, MOVE_SKULL_BASH, MOVE_WATER_SPORT},
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_BlackBeltDaisuke[] = {
    {
        ...
        .lvl = 48,
        .species = SPECIES_MACHAMP,
        .moves = {MOVE_FORESIGHT, MOVE_CROSS_CHOP, MOVE_REVENGE, MOVE_LEER},
        .heldItem = ITEM_BLACK_BELT,
    },
    {
        .iv = 128,
        .lvl = 48,
        .species = SPECIES_PRIMEAPE,
        .moves = {MOVE_SWAGGER, MOVE_CROSS_CHOP, MOVE_SCREECH, MOVE_ASSURANCE},
        .heldItem = ITEM_BLACK_BELT,
    },
    {
        .iv = 128,
        .lvl = 48,
        .species = SPECIES_MACHOKE,
        .moves = {MOVE_FORESIGHT, MOVE_CROSS_CHOP, MOVE_REVENGE, MOVE_SCARY_FACE},
        .heldItem = ITEM_EVIOLITE,
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_JugglerGregory[] = {
    {
        ...
        .lvl = 55,
        .species = SPECIES_JYNX,
        .moves = {MOVE_LOVELY_KISS, MOVE_PSYSHOCK, MOVE_FROST_BREATH, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalCeruleanSquirtle[] = {
    ...
    },
    {
        ...
        .lvl = 15,
        .species = SPECIES_RATTATA,
        .moves = {MOVE_FOCUS_ENERGY, MOVE_TAIL_WHIP, MOVE_QUICK_ATTACK, MOVE_PURSUIT},
    },
    {
        .iv = 100,
        .lvl = 18,
        .species = SPECIES_SQUIRTLE,
        .moves = {MOVE_RAPID_SPIN, MOVE_WITHDRAW, MOVE_WATER_SPORT, MOVE_WATER_GUN},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalCeruleanBulbasaur[] = {
    ...
    },
    {
        ...
        .lvl = 18,
        .species = SPECIES_BULBASAUR,
        .moves = {MOVE_SLEEP_POWDER, MOVE_TACKLE, MOVE_VINE_WHIP, MOVE_LEECH_SEED},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_RivalCeruleanCharmander[] = {
    ...
    },
    {
        ...
        .lvl = 18,
        .species = SPECIES_CHARMANDER,
        .moves = {MOVE_SMOG, MOVE_EMBER, MOVE_GROWL, MOVE_SCRATCH},
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_ScientistBeau[] = {
    {
        ...
        .lvl = 40,
        .species = SPECIES_TENTACRUEL,
        .moves = {MOVE_HYDRO_PUMP, MOVE_RAIN_DANCE, MOVE_NEUROTOXIN, MOVE_NONE},
    },
    {
        .iv = 80,
        .lvl = 40,
        .species = SPECIES_ELECTRODE,
        .moves = {MOVE_THUNDER, MOVE_RAIN_DANCE, MOVE_MIRROR_COAT, MOVE_NONE},
    },
    {
        .iv = 80,
        .lvl = 40,
        .species = SPECIES_SCIZOR,
        .moves = {MOVE_SWORDS_DANCE, MOVE_BULLET_PUNCH, MOVE_PURSUIT, MOVE_NONE},
    },
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_GentlemanRobert2[] = {
    {
        .iv = 128,
        .lvl = 40,
        .species = SPECIES_FLAREON,
...
static const struct TrainerMonNoItemDefaultMoves sParty_GentlemanRobert3[] = {
    {
        .iv = 128,
        .lvl = 54,
        .species = SPECIES_FLAREON,
...
static const struct TrainerMonNoItemCustomMoves sParty_PicnickerSusie2[] = {
    {
        .iv = 128,
        .lvl = 32,
        .species = SPECIES_PIDGEOTTO,
...
static const struct TrainerMonNoItemCustomMoves sParty_SwimmerMaleFinn2[] = {
    {
        .iv = 192,
        .lvl = 54,
        .species = SPECIES_STARMIE,
        .moves = {MOVE_BLIZZARD, MOVE_RECOVER, MOVE_COSMIC_POWER, MOVE_SURF},
    },
};
