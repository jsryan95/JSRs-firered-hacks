const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] = {
    ...
    [MOVE_TECTONIC_CRASH] = _("TECTONIC RAM"),
    [MOVE_GLACIAL_TACKLE] = _("GLACIAL RAM"),
    ...
    [MOVE_PSYCHO_BREAK] = _("PSYCHO BREAK"),
    [MOVE_STORM_BREAK] = _("STORM BREAK"),
    ...
    [MOVE_TRAILBLAZER] = _("TRAILBLAZER"),
    [MOVE_FLASH_FREEZE] = _("FLASH FREEZE"),
    [MOVE_SPIRIT_FLARE] = _("SPIRIT FLARE"),
    [MOVE_SKY_BURST] = _("SKY BURST"),
    [MOVE_DRAGON_SHOUT] = _("DRAGON SHOUT"),
    [MOVE_STAR_SHOOTER] = _("STAR SHOOTER"),
