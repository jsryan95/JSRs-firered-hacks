...
static const u8 sInnerFocusDescription[] = _("Prevents flinching and confusion.");
...
static const u8 sCuteCharmDescription[] = _("Lowers ATTACK on contact.");
...
static const u8 sAdaptabilityDescription[] = _("Powers up different-type attacks.");
static const u8 sSnowWarningDescription[] = _("Summons a hailstorm.");
static const u8 sIceBodyDescription[] = _("Gradually recovers HP in hail.");
static const u8 sHeatproofDescription[] = _("Protects against FIRE attacks.");
...
static const u8 sDefeatistDescription[] = _("Lowers stats when HP is low.");
static const u8 sBigPecksDescription[] = _("Prevents DEFENSE reduction.");
static const u8 sMagicBounceDescription[] = _("Reflects status-changing moves.");
static const u8 sMummyDescription[] = _("Spreads this ability on contact.");
static const u8 sSnowCloakDescription[] = _("Ups evasion in hail.");
static const u8 sFilterDescription[] = _("Protects against super-effective attacks.");
static const u8 sTintedLensDescription[] = _("Powers up not-very-effective attacks.");
static const u8 sMultiscaleDescription[] = _("Takes less damage at full HP.");
static const u8 sRecklessDescription[] = _("Powers up recoil attacks.");
static const u8 sScrappyDescription[] = _("Attacks can hit GHOST-types.");
...
static const u8 sOvercoatDescription[] = _("Protects against weather damage.");
static const u8 sSandForceDescription[] = _("Raises power in a sandstorm.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_ICE_SKATER] = _("ICE SKATER"),
