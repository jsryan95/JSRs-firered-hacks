...
const u8 gMoveDescription_SonicBoom[] = _("A shock wave that\ninflicts damage\nequal to the\nuser's level.");
...
const u8 gMoveDescription_Kinesis[] = _("Bends a spoon to\ndistract the foe\nand lower its SP.\nATK and SP. DEF.");
const u8 gMoveDescription_SoftBoiled[] = _("Heals the user or\nan ally by up to\nhalf its full HP.");
...
const u8 gMoveDescription_ZapCannon[] = _("Always paralyses\nthe foe, but the\nuser must recharge\nnext turn.");
...
const u8 gMoveDescription_MilkDrink[] = _("Heals the user or\nan ally by up to\nhalf its full HP.");
...
const u8 gMoveDescription_Attract[] = _("By acting cutely,\nthe foe is made\ninfatuated and\nunlikely to attack.");
...
const u8 gMoveDescription_DynamicPunch[] = _("Always confuses\nthe foe, but the\nuser must recharge\nnext turn.");
...
const u8 gMoveDescription_MudSport[] = _("Spreads mud to\nlower the SPEED of\nall POKéMON except\nGROUND-types.");
...
const u8 gMoveDescription_BlastBurn[] = _("Blasts the foe and\nremoves its item.\nThe user can't move\non the next turn.");
const u8 gMoveDescription_HydroCannon[] = _("A watery cannon\nforces the foe out.\nThe user can't move\non the next turn.");
...
const u8 gMoveDescription_SheerCold[] = _("The foe is frozen\nby ultimate cold.\nThe user must\nrecharge next turn.");
...
const u8 gMoveDescription_FrenzyPlant[] = _("Huge roots damage\nand trap the foe.\nThe user can't move\non the next turn.");
...
const u8 gMoveDescription_WaterSport[] = _("Sprays water\neverywhere to\nmake each POKéMON's\nability DAMP.");
...
const u8 gMoveDescription_SandBlaster[] = _("Unleashes a vicious\nstream of sand\nthat always lands\na critical hit.");
const u8 gMoveDescription_MagnetShock[] = _("A magnetic blast\nthat deals great\ndamage to STEEL\n-type POKéMON.");
const u8 gMoveDescription_TidalCrash[] = _("An intense attack\nthat also sharply\nreduces the user's\nSPEED stat.");
const u8 gMoveDescription_UTurn[] = _("After making its\nattack, the user\nswitches places with\na party Pokémon.");
const u8 gMoveDescription_IceFang[] = _("A bite that may\nfreeze the foe or\nmake it flinch.");
const u8 gMoveDescription_FireFang[] = _("A bite that may \nburn the foe or\nmake it flinch.");
const u8 gMoveDescription_ThunderFang[] = _("A bite that may \nparalyse the foe\nor make it flinch.");
const u8 gMoveDescription_Assurance[] = _("Doubles power if\nthe foe has\nalready taken\ndamage this turn.");
...
const u8 gMoveDescription_XScissor[] = _("Slashes at the\nfoe by crossing\nits claws like a\npair of scissors.");
...
const u8 gMoveDescription_DracoMeteor[] = _("Summons comets\nfrom the sky.\nSharply lowers the\nuser's SP. ATK stat.");
...
const u8 gMoveDescription_ChargeBeam[] = _("Fires concentrated\nelectricity in a\nbeam. May raise\nthe user's SP. ATK.");
const u8 gMoveDescription_CloseCombat[] = _("A reckless attack\nthat lowers both\nthe user's and\ntarget's DEFENSE.");
...
const u8 gMoveDescription_RagePowder[] = _("Scatters an\nirritating powder,\nmaking foes attack\nonly the user.");
...
const u8 gMoveDescription_StoredPower[] = _("A powerful attack\nthat fails if the\nuser's stats have\nnot been raised.");
...
const u8 gMoveDescription_DragonTail[] = _("Knocks away the\nfoe and drags out\nanother POKéMON in\nits party.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_DRAGON_RAGE   - 1] = gMoveDescription_SonicBoom,
    ...
    [MOVE_SAND_BLASTER  - 1] = gMoveDescription_SandBlaster,
    [MOVE_MAGNET_SHOCK  - 1] = gMoveDescription_MagnetShock,
    [MOVE_TIDAL_CRASH   - 1] = gMoveDescription_TidalCrash,
    ...
    [MOVE_HORN_LEECH - 1] = gMoveDescription_GigaDrain,
