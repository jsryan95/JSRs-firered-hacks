...
static const struct RematchData sRematches[] = {
   ...
   { {TRAINER_BUG_CATCHER_GREG, TRAINER_BUG_CATCHER_GREG},
      MAP(MAP_ROUTE3) },
   { {TRAINER_BEAUTY_JAMIE, TRAINER_BEAUTY_JAMIE},
      MAP(MAP_ROUTE3) },
   ...
   { {TRAINER_LASS_CRISSY, TRAINER_LASS_CRISSY},
      MAP(MAP_ROUTE4) },
   { {TRAINER_BIRD_KEEPER_STUART, TRAINER_BIRD_KEEPER_STUART},
      MAP(MAP_ROUTE4) },
   ...
   { {TRAINER_YOUNGSTER_DAVE, TRAINER_YOUNGSTER_DAVE},
      MAP(MAP_ROUTE11) },
   { {TRAINER_COOLTRAINER_SANDY, TRAINER_COOLTRAINER_SANDY},
      MAP(MAP_ROUTE11) },
   { {TRAINER_ENGINEER_BERNIE, SKIP, SKIP, TRAINER_ENGINEER_BERNIE_2},
      MAP(MAP_ROUTE11) },
   { {TRAINER_GAMER_HUGO, TRAINER_GAMER_HUGO},
      MAP(MAP_ROUTE11) },
   { {TRAINER_COOLTRAINER_JASPER, TRAINER_COOLTRAINER_JASPER},
      MAP(MAP_ROUTE11) },
   ...
   { {TRAINER_BIRD_KEEPER_PERRY, TRAINER_BIRD_KEEPER_PERRY},
      MAP(MAP_ROUTE13) },
   { {TRAINER_GENTLEMAN_ROBERT, SKIP, SKIP, TRAINER_GENTLEMAN_ROBERT_2, TRAINER_GENTLEMAN_ROBERT_3},
      MAP(MAP_ROUTE13) },
   ...
   { {TRAINER_BEAUTY_OLIVIA, TRAINER_BEAUTY_OLIVIA},
      MAP(MAP_ROUTE15) },
   { {TRAINER_EXPERT_ESME, TRAINER_EXPERT_ESME},
      MAP(MAP_ROUTE15) },
